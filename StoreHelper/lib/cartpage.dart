...
import 'package:storehelper/checkoutpage.dart';
...
//  const CartPage({Key? key, required this.email}) : super(key: key);
  ...
  const CartPage({Key key, this.user, int curtab}) : super(key: key);
...
class _CartPageState extends State<CartPage> {
  ...
  void _modQty(int index, String s) {
    http.post(Uri.parse("https://crimsonwebs.com/s272043/storehelper/php/updateusercart.php"),
        body: {
  ...
  void _deleteCart(int index) {
    http.post(Uri.parse("https://crimsonwebs.com/s272043/storehelper/php/deleteusercart.php"),
        body: {
          "email": widget.user.email,
          "prid": _cartList[index]['productId']
        }).then((response) {
